...
//        }
      ...
      if(o.Callback){
    	  o.Callback.call(this, numChecked, value, $checked.get());
      }
      return value;
    },
    ...
    _setButtonValue: function(value) {
    	if(value!==undefined){
    		var values;
    		var isEllipsis='N';
    		//maxlength字符显示长度，可不写，默认字符显示长度35，超过长度省略号代替。
    		while (value.length>this.options.maxlength){
    			values=value.split(',');
    			values.pop();//移除最后一个元素。
    			value=values.join(',');
    			isEllipsis='Y';//省略号标志。
...
//      }
    ...
    _setMenuWidth: function() {
      ...
      m.outerWidth(this.options.menuWidth);
    },
